// Configuration for Education Certificate contract.
...
const educationCertificate = {
  ...
  abi: [
      ...
      outputs: [
        {
          ...
          internalType: 'struct EducationCertificate.Certificate',
          name: '',
          type: 'tuple',
        },
      ],
    ...
    {
      inputs: [],
      name: 'gradingContract',
      outputs: [
        {
          internalType: 'contract IGradingSystem',
          name: '',
          type: 'address',
        },
      ],
    ...
    },
    {
      inputs: [
        {
          internalType: 'address',
          name: '_newGradingContractAddress',
          type: 'address',
        },
        {
          internalType: 'address',
